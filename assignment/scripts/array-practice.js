...
let favoriteFoods = ['chicken tikka masala', 'alambre', 'fresh cheese curds'];
...
console.log('The second animal in this array is', secondAnimal);
...
console.log('The fourth animal is', lastAnimal);
